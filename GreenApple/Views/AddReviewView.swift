...
struct AddReviewView: View {
        ...
        NavigationStack {
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    .disabled(comment.isEmpty || isSubmitted)
    ...
    private func submitReview() {
        ...
        let review = Review(
            id: UUID(),
            authorName: viewModel.username.isEmpty ? (viewModel.currentUser?.email?.components(separatedBy: "@").first ?? "Anonymous") : viewModel.username,
